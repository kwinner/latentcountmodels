...
static const char __pyx_k_Users_sheldon_projects_latentco[] = "/Users/sheldon/projects/latentcountmodels/python/lsgdual/cygdual.pyx";
...
static PyObject *__pyx_pf_7cygdual_cygdual_exp(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_u) {
  ...
  __pyx_pybuffernd_u.rcbuffer = &__pyx_pybuffer_u;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_u.rcbuffer->pybuffer, (PyObject*)__pyx_v_u, &__Pyx_TypeInfo_nn_struct_ls, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 26, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_FromSize_t(__pyx_v_n); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_LS_DTYPE); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 36, __pyx_L1_error)
 ...
 *     return v
 */
  gdual_exp(((struct ls *)__pyx_v_u->data), ((struct ls *)__pyx_v_v->data), __pyx_v_n);
