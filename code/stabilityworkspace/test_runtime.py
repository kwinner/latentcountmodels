...
runtime_ngdual, runtime_pgffa, runtime_trunc_best, runtime_trunc_total, n_max_trunc, Rho_test = runtime_vs_rho_gen()
runtime_plot(runtime_ngdual, runtime_pgffa, runtime_trunc_best, Rho_test)